...
import ModalContainer from '@Custom/ModalContainer/ModalContainer.jsx'
...
export default function PostModal({ setOpenModal, watchers, buttonClick, selectedPost, setSelectedPost }) {
    ...
    const handlePostClick = (post) => {
        setSelectedPost(prevState => {
            if (prevState.includes(post)) {
                return prevState.filter(prev => prev?.id !== post?.id);
            } else {
                    ...
                    filteredPosts?.map((item, index) => (
                        ...
                        >
                            <div
                                ...
                                ${selectedPost.includes(item) ? classes.selected : ''}
                                `}
                            >
                                ...
                                <div className={classes.roundSection}>
                                    <img 
                                        src={selectedPost.includes(item) ? round_check_true : round_check} 
                                        alt="round_check" 
                                    />
                                </div>
                            </div>
