...
const MainPolicy = () => {
  ...
  const TYPE_DISPLAY = {
    0: {
      type: "Отменён",
      arrayDirectives: archiveDirectives,
      arrayInstruction: archiveInstructions,
    },
    1: {
      type: "Активный",
      arrayDirectives: activeDirectives,
      arrayInstruction: activeInstructions,
    },
    2: {
      type: "Черновик",
      arrayDirectives: draftDirectives,
      arrayInstruction: draftInstructions,
    },
  };
  ...
  return (
    <>
                ...
                >
                  <div>
                    ...
                    <img
                      ...
                      alt="sublist"
                      style={{
                        transform: !openInstruction ? "rotate(90deg)" : "none",
                      }}
                    />
                  </div>
                </div>
                  ...
                  <>
                    <div className={classes.selectType}>
                      ...
                      <div
                        ...
                        onClick={() =>
                          switchDisplayType("right", "instruction")
                        }
                      >
                    ...
                    <ul className={classes.selectList}>
                      ...
                      {displayInstruction.arrayInstruction.map(
                        (item, index) => (
                          <li
                            key={index}
                ...
                >
                  <div>
                    ...
                    <img
                      ...
                      alt="sublist"
                      style={{
                        transform: !openDirectives ? "rotate(90deg)" : "none",
                      }}
                    />
                  </div>
                </div>
      ...
      <HandlerMutation
        ...
        Error={
          isErrorPostPoliciesMutation && localIsResponsePostPoliciesMutation
        }
        Success={
          isSuccessPostPoliciesMutation && localIsResponsePostPoliciesMutation
        }
