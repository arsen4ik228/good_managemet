...
import { useGetDataCreatePost, useCreatePost } from "@hooks";
import { isMobile } from "react-device-detect"; 

const { TextArea } = Input;

export default function DrawerCreatePost({ open, setOpen, organizationId }) {
  ...
  return (
    ...
    >
      <Flex vertical={true} style={{ height: "100%"}}>
        <Form form={formPost} layout="vertical" style={{ flexGrow: 1 }}>
          {/* Название поста */}
          <Form.Item
