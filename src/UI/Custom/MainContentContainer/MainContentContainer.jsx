...
export default function MainContentContainer({component, buttons, children, popoverButton, arrayName}) {
                        ...
                        {component}
                        {
                            arrayName && (
                                <div className={classes.sectionName}>
                                    <div>
                                        {arrayName[0]?.label}
                                        <span className={classes.bold}>{arrayName[0]?.value}</span>
                                    </div>
                                    <div>
                                        {arrayName[1]?.label}
                                        <span className={classes.bold}>{arrayName[1]?.value}</span>
                                    </div>
                                </div>
                            )
                        }
